...
<head>
	<title>Franej Educational Centre - LOGIN</title>
	<meta charset='utf-8' />
...
<body>
	<div class='container-fliud'>
		<header class='row' id='login-header'>
			<div class='col-md-2'>

			</div>

			<div class='col-md-8 text-center'>
				<a href="#"><img src="assets/image/logo.png" alt="" class="img-fluid mt-3"></a>
				<h1 style='color: #fff;'>Franej Educational Centre</h1>
			</div>
					...
					<div class='col-md-12' id='log'>
						<div class='panel panel-primary'>
							<div class='panel-heading'>
								<h1 class='log-text'>Student / Staff Login</h1>
								<p>
									<?php
									if (isset($msg)) {
										echo $msg;
							...
							<div class='panel-body'>
								<form method='POST' action=''>
									<div class='input-group'>
										...
										<input type='text' name='login_id' placeholder='Enter Reg No OR Email Address' class='form-control form-control-lg' />
									</div>
									<br />

									<div class='input-group'>
										<span class='input-group-addon' id='basic-addon2'>Password</span>
										<input type='password' name='login_password' placeholder='Enter Password' class='form-control form-control-lg' />
									</div>
									<br />
